...
> Thus, we believe that **Bayesian analysis** can **clarify** the interpretation of these **results** for clinicians.
...
We will report the **Absolute risk difference** (ARD) of tocilizumab minus the control group for each prior. An ARD **smaller than zero** means **tocilizumab** is **better** for the **mortality** outcome.
