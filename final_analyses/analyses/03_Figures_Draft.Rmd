...
load(here("final_analyses", "output", "data","analyses", # file path
...
p1 = distributions_cortico %>%
  ...
  scale_x_continuous(breaks = seq(from = -1, to = 1, 0.5)) +
...
p2 = distributions_respiratory %>%
  ...
  scale_x_continuous(breaks = seq(from = -1, to = 1.5, 0.5)) +
...
```{r , fig.align='center', fig.width=10, fig.height = 8.5, warning=FALSE, fig.cap="Panels A and C: Point estimates depict the median. Interval bars depict the 50 and 95% credible intervals. Panels B and D: Cumulative posterior distributions correspond to the probabilities that the risk difference (RD) is greater than or equal to the effect size on the X‐axis."}
...
Here are the 95% quantile intervals in *risk difference* of distributions on the use of
corticosteroids. "_not" means not using and "_u" means using corticosteroids.
...
Here are the 95% quantile intervals in *risk difference* of distributions on
...
Here are the 95% quantile intervals in *risk difference* of each distribution.
