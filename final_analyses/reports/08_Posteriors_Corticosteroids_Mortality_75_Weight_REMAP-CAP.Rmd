---
title: "08_Posteriors_Corticosteroids_Mortality_75_Weight_REMAPCAP"
...
p1 = all_posteriors_75_using_cortico_death %>%
...
```{r}
p2 = all_posteriors_75_not_cortico_death %>%
...
```{r}
# Summary table
table_posterior = summary_table_death(all_posteriors_75_using_cortico_death)
...
```{r}
# Summary table
table_posterior = summary_table_death(all_posteriors_75_not_cortico_death)
...
data_prior_posterior_plot(
  multiple_priors_75_using_cortico_death %>% # Output from normal_approximation()
...
data_prior_posterior_plot(
  multiple_priors_75_not_cortico_death %>% # Output from normal_approximation()
    filter(type == "evidence-based"), 
