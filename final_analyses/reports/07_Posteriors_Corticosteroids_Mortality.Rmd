---
title: "07_Posteriors_Corticosteroids_Mortality"
...
library(flextable) # To create quick tables
...
p1 = all_posteriors_using_cortico_death %>%
  ...
  scale_fill_manual(values = c("gray90", "#E98A33")) +
  labs(x = "\nRisk difference (%)",
       y = "Underlying prior\n",
...
```{r}
p2 = all_posteriors_not_cortico_death %>%
...
```{r}
# Summary table
table_posterior = summary_table_death(all_posteriors_using_cortico_death)
...
```{r}
# Summary table
table_posterior = summary_table_death(all_posteriors_not_cortico_death)
...
data_prior_posterior_plot(
  multiple_priors_using_cortico_death %>% # Output from normal_approximation()
...
data_prior_posterior_plot(
  multiple_priors_not_cortico_death %>% # Output from normal_approximation()
    filter(type == "evidence-based"), 
