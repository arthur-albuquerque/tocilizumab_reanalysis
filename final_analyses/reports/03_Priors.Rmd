...
table_prior =  tibble(
  ...
  "Mean RD" = c(
    round(mean_prior_only, 2),
    round(mean_prior_noninvasive, 2),
    round(mean_prior_invasive, 2)
  ),
  
  "SD of RD" = c(
    round(sd_prior_only, 2),
    round(sd_prior_noninvasive, 2),
    round(sd_prior_invasive, 2)
  ),
  
  "Pr(< -10%)" = c(
    round(pnorm(-0.1, mean_prior_only, sd_prior_only), 2) * 100,
    round(pnorm(-0.1, mean_prior_noninvasive, sd_prior_noninvasive), 2) * 100,
    round(pnorm(-0.1, mean_prior_invasive, sd_prior_invasive), 2) * 100
  ),
  ...
  "Pr(> 10%)" = c(
    round((1 - pnorm(0.1, mean_prior_only, sd_prior_only)), 2) * 100,
    round((1 - pnorm(0.1, mean_prior_noninvasive, sd_prior_noninvasive)), 2) * 100,
    round((1 - pnorm(0.1, mean_prior_invasive, sd_prior_invasive)), 2) * 100
  )
)
...
table_prior %>% 
  ...
  add_header_above(c(" " = 5, "Probability of Treatment Effect" = 5)) %>% 
