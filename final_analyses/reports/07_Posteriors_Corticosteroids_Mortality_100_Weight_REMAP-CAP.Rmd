---
title: "07_Posteriors_Corticosteroids_Mortality_100%_Weight_REMAPCAP"
...
p1 = all_posteriors_100_using_cortico_death %>%
...
```{r}
p2 = all_posteriors_100_not_cortico_death %>%
...
```{r, fig.align='center', fig.height=7, fig.width=9,fig.cap="Interval bars depict the 50th and 95th quantiles."}
...
```{r}
# Summary table
table_posterior = summary_table_death(all_posteriors_100_using_cortico_death)
...
```{r}
# Summary table
table_posterior = summary_table_death(all_posteriors_100_not_cortico_death)
...
data_prior_posterior_plot(
  multiple_priors_100_using_cortico_death %>% # Output from normal_approximation()
...
data_prior_posterior_plot(
  multiple_priors_100_not_cortico_death %>% # Output from normal_approximation()
    filter(type == "evidence-based"), 
