...
priors_using_cortico_data_death =
  d %>%
  filter(
    trial != "RECOVERY",
...
priors_using_cortico_death =
  rma(
    ...
    data = priors_using_cortico_data_death %>% filter(outcome == "mortality"),

    slab = paste(trial),
    method = "REML"
  )

forest(priors_using_cortico_death)
...
# save(priors_using_cortico_death,
#      
#      file = here("final_analyses", "output", "data",
#                  "priors_using_cortico_death.RData"))
...
recovery_using_cortico_normal_death = normal_approximation(
  ...
  recovery_using_cortico_normal_death # Repeat the name of the object you are creating
)
```

```{r include=FALSE}
multiple_priors_using_cortico_death =
  normal_approximation_multiple_priors(
  # Data object with evidence-based posterior from normal_approximation()
  recovery_using_cortico_normal_death, 
  "mortality", # Outcome (within quotes)
  multiple_priors_using_cortico_death # Name for the final output with data+prior+posterior
  )
```

```{r}
multiple_priors_using_cortico_death %>% flextable() %>% autofit()
```
...
all_posteriors_using_cortico_death = tibble_all_posteriors(
...
```{r}
head(all_posteriors_using_cortico_death)%>% flextable() %>% autofit()
```
...
# save(multiple_priors_using_cortico_death,
#      
#      file = here("final_analyses", "output", "data",
#                   "multiple_priors_using_cortico_death.RData"))
...
# save(all_posteriors_using_cortico_death,
#      
#      file = here("final_analyses", "output", "data",
#                  "all_posteriors_using_cortico_death.RData"))
...
priors_not_cortico_death =
  rma(
    ...
    data = priors_not_cortico_data_death %>% filter(outcome == "mortality"),

    slab = paste(trial),
    method = "REML"
  )

forest(priors_not_cortico_death)
...
# save(priors_not_cortico_death,
#      
#      file = here("final_analyses", "output", "data",
#                  "priors_not_cortico_death.RData"))
...
recovery_not_cortico_normal_death = normal_approximation(
  ...
  recovery_not_cortico_normal_death # Repeat the name of the object you are creating
)
```

```{r include=FALSE}
multiple_priors_not_cortico_death =
  normal_approximation_multiple_priors(
  # Data object with evidence-based posterior from normal_approximation()
  recovery_not_cortico_normal_death, 
  "mortality", # Outcome (within quotes)
  multiple_priors_not_cortico_death # Name for the final output with data+prior+posterior
  )
```

```{r}
multiple_priors_not_cortico_death %>% flextable() %>% autofit()
```
...
all_posteriors_not_cortico_death = tibble_all_posteriors(
...
```{r}
head(all_posteriors_not_cortico_death)%>% flextable() %>% autofit()
```
...
# save(multiple_priors_not_cortico_death,
#      
#      file = here("final_analyses", "output", "data",
#                   "multiple_priors_not_cortico_death.RData"))
...
# save(all_posteriors_not_cortico_death,
#      
#      file = here("final_analyses", "output", "data",
#                  "all_posteriors_not_cortico_death.RData"))
